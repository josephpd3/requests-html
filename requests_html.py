...
class HTMLSession(requests.Session):
    ...
    def __init__(self, mock_browser=True, pyppeteer_launch_conf={}):
        ...
        self.pyppeteer_launch_conf = pyppeteer_launch_conf
    ...
    def browser(self):
        if not hasattr(self, "_browser"):
            ...
            self._browser = self.loop.run_until_complete(pyppeteer.launch(headless=True, args=['--no-sandbox'], **self.pyppeteer_launch_conf))
